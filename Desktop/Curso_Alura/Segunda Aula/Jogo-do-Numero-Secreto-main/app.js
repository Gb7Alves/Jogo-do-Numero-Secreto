...
// Adiciona um evento para capturar a tecla "Enter" no campo de input
document.querySelector(".container__input").addEventListener("keydown", function(event) {
    if (event.key === "Enter") {
        verificarChute(); // Chama a função de verificar o chute
    }
});
...
function verificarChute() {
    let chute = document.querySelector(".container__input").value;  // Obtém o valor digitado no campo de input
...
function limparCampo() {
    let campo = document.querySelector(".container__input");  // Seleciona o campo de input
